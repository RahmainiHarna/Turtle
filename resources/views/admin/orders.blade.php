...
<body>
	<section id="sidebar">
		...
		<ul class="side-menu top">
			...
			<li class="active"><a href="{{ route('orders') }}"><i class='bx bxs-shopping-bag-alt'></i><span class="text">Orders</span></a></li>
			<li><a href="{{route('testimonialsAdmin')}}"><i class='bx bxs-message-dots'></i><span class="text">Testimoni</span></a></li>
			<li><a href="{{ route('messages') }}"><i class='bx bxs-message-dots'></i><span class="text">Message</span></a></li>
			@auth
				<li>
   ...
   <div style="display: flex; align-items: center; gap: 8px">
	...
	<input type="text" id="searchInput" onkeyup="searchTable()" placeholder="Cari nama..."
        ...
        <form action="{{ route('admin.orderdelete', $data_diri->id) }}" method="POST" style="display:inline;">
        @csrf
        @method('DELETE')
