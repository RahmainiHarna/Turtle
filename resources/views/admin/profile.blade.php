    ...
    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            ...
            <div>
                ...
                @if($admin->photo)
                    <img src="{{ asset($admin->photo) }}" class="preview-img" id="preview">
                @else
        ...
        <div class="button-wrapper">
            <a href="{{ route('admin') }}" class="btn-back"><i class="fa-solid fa-arrow-left" style="margin-right: 8px;"></i>BACK</a>
